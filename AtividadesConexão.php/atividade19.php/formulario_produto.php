...
<body>
    ...
    <form action="./conexao_banco.php" method="POST">

        <h1>Formulario dos Produtos</h1>

        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Nome Produtos</label>
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nome_produtos">
        </div>
